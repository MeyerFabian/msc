...
With the mentioned partitioning of the grid into blocks the shared memory architecture of the GPU can be exploited. This requires two-level binning of particles to nodes within blocks.
...
\begin{algorithm}[t]
  ...
  \begin{algorithmic}[1]
    ...
    \ForAll{$(node,local\_id) \in \text{assignedNodes}(blockNode, H\_FLAT)$}
      ...
      \ForAll{$neighbor\_id \in \text{support}(blockNode)$}
