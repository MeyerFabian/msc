...
\end{equation}
\begin{equation}
  \nabla w_{\boldsymbol{i}}(\boldsymbol{x})
  =\frac { 1 } {  { h } }
  \left(
    \begin{array} {l}
      w^{\prime} (\frac { 1 } {  { h } } ( x  - x _ { i } ))  { w }          ( \frac { 1 } {  { h } } (  { y }  -  { y } _ { i}  ) )   { w }         ( \frac { 1 } {  { h } } ( z  - z _ { i } ) \\
      w(\frac{1} {  { h } } ( x  - x _ { i } ))               { w }^{\prime} ( \frac { 1 } {  { h } } (  { y }  -  { y } _ { i}  ) )   { w }         ( \frac { 1 } {  { h } } ( z  - z _ { i } ) \\
      w(\frac{1} {  { h } } ( x  - x _ { i } ))               { w }          ( \frac { 1 } {  { h } } (  { y }  -  { y } _ { i}  ) )   { w }^{\prime}( \frac { 1 } {  { h } } ( z  - z _ { i } ) \\
    \end{array}
  \right)
\end{equation}
