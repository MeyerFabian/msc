...
Any conservative integrator could be used to discretize time. The implicit midpoint rule is one of such ($\lambda =\frac{1}{2}$)
\begin{equation}\label{eq:midpoint}
  \frac{y ^ { n + 1 } - y ^ { n }}{ \Delta t} =  f \left(t^n+\frac{\Delta t}{2}, \frac { y ^ { n } + y^{n+1}}{2}\right)
\end{equation}
