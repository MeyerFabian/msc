...
\begin{equation}\label{eq:space_discr}
  \frac{1}{\Delta t} ({m\boldsymbol{v}_i^{n+1}}-{m\boldsymbol{v}_i^{n}}) =
...
$$
  f_{i\alpha} \stackrel{\text{\ref{eq:piola},\ref{eq:volume_discr}}}{=}
  - \sum_p \frac{1}{J^n_p}P^n_{p\alpha\gamma}F^n_{p\beta\gamma}\frac{\partial w_{ip}}{\partial x_\beta}V^0_pJ^n_p
$$
\begin{equation}
  = - \sum_p P^n_{p\alpha\gamma}F^n_{p\beta\gamma}\frac{\partial w_{ip}}{\partial x_\beta}V^0_p
\end{equation}
